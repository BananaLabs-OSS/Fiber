...
func hostReadPreface(uint32, uint32, uint32, uint32) uint32 { return 99 }
func hostStartRead(uint32, uint32) uint32                   { return 99 }
func hostBridge(uint32, uint32) uint32                      { return 99 }
