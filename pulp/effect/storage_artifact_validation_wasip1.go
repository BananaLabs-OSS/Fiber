...
//go:wasmimport pulp s3_exact_object_validate_artifact_zip
func hostStorageExactObjectArtifactZIPValidate(reqPtr, reqLen, respPtrOut, respLenOut uint32) uint32

var storageArtifactZIPValidateWire = hostStorageArtifactZIPValidateWire

func hostStorageArtifactZIPValidateWire(request []byte) ([]byte, uint32) {
	var responsePtr, responseLen uint32
	code := hostStorageExactObjectArtifactZIPValidate(
