...
//go:wasmimport pulp s3_exact_object_download_reference
func hostStorageExactObjectDownloadReference(reqPtr, reqLen, respPtrOut, respLenOut uint32) uint32

var storageExactObjectDownloadReferenceWire = hostStorageExactObjectDownloadReferenceWire

func hostStorageExactObjectDownloadReferenceWire(request []byte) ([]byte, uint32) {
	var responsePtr, responseLen uint32
	code := hostStorageExactObjectDownloadReference(
