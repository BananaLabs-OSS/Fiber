...
//go:wasmimport pulp http_probe_execute
func hostHTTPProbeExecute(reqPtr, reqLen, respPtrOut, respLenOut uint32) uint32

var executeWire = callHTTPProbeExecute

func callHTTPProbeExecute(request []byte) ([]byte, uint32) {
	var responsePtr, responseLen uint32
	code := hostHTTPProbeExecute(
